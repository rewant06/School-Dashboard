...
import { Class, Prisma, Teacher } from "@prisma/client"; // Importing Prisma types for type safety.
...
type ClassList = Class & { supervisor: Teacher }; // Defining a type that combines Class and Teacher data.
...
const ClassListPage = async ({
  ...
  const renderRow = (item: ClassList) => (
    ...
    >
      ...
      <td className="hidden md:table-cell">{item.grade}</td> {/* Class grade */}
  ...
  const [data, count] = await prisma.$transaction([ // Fetching class data and total count using Prisma transactions.
